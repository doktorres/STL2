...
{
		var Clone = Instantiate (Item.equippedHelmetVersion, HelmetSlot.position, HelmetSlot.rotation);
		Clone.name = Item.equippedHelmetVersion.name;
		Clone.transform.parent = HelmetSlot;
		if (DebugMode)
		{
			Debug.Log(Item.name + " has been placed as Helmet");
		}
}
...
{	if (Item.equippedWeaponVersion != null)
	{
		...
		if (DebugMode)
		{
			Debug.Log(Item.name + " has been removed as Helmet");
		}
	}
}
